...
namespace AbpFacebookRegistration.Users
{
    ...
    public class AppUser : FullAuditedAggregateRoot<Guid>, IUser
    {
         ...
         *
         * 1. Update AbpFacebookRegistrationDbContext.OnModelCreating
         * to configure the mapping for your new property
         * 2. Update AbpFacebookRegistrationEfCoreEntityExtensionMappings to extend the IdentityUser entity
