...
{
    public static class AbpFacebookRegistrationEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE AbpFacebookRegistrationModuleExtensionConfigurator CLASS (in the Domain.Shared project)
